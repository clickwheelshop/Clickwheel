      ...
      <section className="border-b border-black/10 px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-6 max-w-2xl text-base leading-7 text-black/65 sm:text-lg">
            Delivery information for ready-to-ship and built-to-order Clickwheel
            devices.
          </p>
          ...
          <div className="space-y-14">
            <section id="where-we-deliver">
              ...
              <div className="mt-5 space-y-4 text-base leading-7 text-black/65">
                <p>
                  Clickwheel orders are dispatched from Romania.
                </p>

                <p>
                  We currently deliver within Romania and to selected European
                  destinations. Availability for a specific address is confirmed
                  during checkout or before payment is completed.
                </p>

                <p>
                  We do not currently offer delivery outside Europe.
                </p>
              </div>
            </section>
            ...
            <section id="delivery-costs">
              ...
              <div className="mt-5 space-y-4 text-base leading-7 text-black/65">
                ...
                <p>
                  ...
                  entered at checkout. The available shipping options and their
                  prices are shown before payment.
                </p>
            ...
            <section id="tracking">
              ...
              <div className="mt-5 space-y-4 text-base leading-7 text-black/65">
                ...
                <p>
                  Delivery dates and transit times are estimates provided by the
                  carrier. They may vary depending on destination, local
            ...
            <section id="undeliverable">
              ...
              <div className="mt-5 space-y-4 text-base leading-7 text-black/65">
                <p>
                  ...
                  collection instructions are accurate before placing an order.
                </p>
