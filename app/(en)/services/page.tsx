...
const servicesTitle = "iPod Classic Services";
const servicesDescription =
  "Explore Clickwheel workshop services for iPod Classic upgrades, refurbishment support and configuration guidance.";
